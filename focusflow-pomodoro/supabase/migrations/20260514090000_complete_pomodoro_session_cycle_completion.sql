-- Aligns the RPC with the client timer flow:
-- - complete the session
-- - increment task progress only when the long-break cycle is fulfilled
-- - complete the task when the estimate is reached
-- - never change estimated_pomodoros during completion
